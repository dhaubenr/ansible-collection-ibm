...
for_more_info:  refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/resources/security_group_rule
...
TL_CONFLICTS_MAP = {
    'remote_group_id': ['remote_ip'],
    'remote_ip': ['remote_group_id'],
}
