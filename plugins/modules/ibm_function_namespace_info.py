...
DOCUMENTATION = '''
---
module: ibm_function_namespace_info
for_more_info: refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/data-sources/function_namespace

short_description: Retrieve IBM Cloud 'ibm_function_namespace' resource
...
def run_module():
    ...
    result = ibmcloud_terraform(
        resource_type='ibm_function_namespace',
        tf_type='data',
