...
for_more_info:  refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/resources/cr_namespace

short_description: Configure IBM Cloud 'ibm_cr_namespace' resource
...
def run_module():
    ...
    result = ibmcloud_terraform(
        resource_type='ibm_cr_namespace',
        tf_type='resource',
