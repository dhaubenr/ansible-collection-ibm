...
DOCUMENTATION = '''
---
module: ibm_pi_ipsec_policy
for_more_info:  refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/resources/pi_ipsec_policy

short_description: Configure IBM Cloud 'ibm_pi_ipsec_policy' resource
...
def run_module():
    ...
    result = ibmcloud_terraform(
        resource_type='ibm_pi_ipsec_policy',
        tf_type='resource',
