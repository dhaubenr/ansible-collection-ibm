...
DOCUMENTATION = '''
---
module: ibm_appid_apm
for_more_info:  refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/resources/appid_apm

short_description: Configure IBM Cloud 'ibm_appid_apm' resource
...
module_args = dict(
    ...
    lockout_policy=dict(
        ...
        elements='',
        type='list'),
    min_password_change_interval=dict(
        required=False,
        elements='',
        type='list'),
    tenant_id=dict(
    ...
    enabled=dict(
        required=False,
        type='bool'),
    prevent_password_with_username=dict(
        required=False,
        type='bool'),
    password_reuse=dict(
        required=False,
