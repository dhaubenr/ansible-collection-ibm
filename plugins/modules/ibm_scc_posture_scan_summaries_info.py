...
DOCUMENTATION = '''
---
module: ibm_scc_posture_scan_summaries_info
for_more_info: refer - https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/data-sources/scc_posture_scan_summaries

short_description: Retrieve IBM Cloud 'ibm_scc_posture_scan_summaries' resource
...
def run_module():
    ...
    result = ibmcloud_terraform(
        resource_type='ibm_scc_posture_scan_summaries',
        tf_type='data',
